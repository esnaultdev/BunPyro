 ...
 *
 * Extracted from kotlin.Result, but not an inline class to avoid this issue in Kotlin 1.4.31:
 * https://youtrack.jetbrains.com/issue/KT-45259
 * Note that @SinceKotlin and contracts were removed for simplicity.
 */
