...
class OrgSQLiteDatabase implements SupportSQLiteDatabase {
     ...
     */
    OrgSQLiteDatabase(SQLiteDatabase delegate) {
        mDelegate = delegate;
    }

    @Override
    public SupportSQLiteStatement compileStatement(String sql) {
        return new OrgSQLiteStatement(mDelegate.compileStatement(sql));
    }
    ...
    public void beginTransactionWithListener(SQLiteTransactionListener transactionListener) {
        mDelegate.beginTransactionWithListener(toOrgTransactionListener(transactionListener));
    }
    ...
    public void beginTransactionWithListenerNonExclusive(
        ...
        mDelegate.beginTransactionWithListenerNonExclusive(
                toOrgTransactionListener(transactionListener));
    }

    private org.sqlite.database.sqlite.SQLiteTransactionListener toOrgTransactionListener(
            SQLiteTransactionListener transactionListener
    ) {
        return new org.sqlite.database.sqlite.SQLiteTransactionListener() {
                    @Override
                    public void onBegin() {
    ...
    public Cursor query(final SupportSQLiteQuery supportQuery) {
        return mDelegate.rawQueryWithFactory(new SQLiteDatabase.CursorFactory() {
            ...
            public Cursor newCursor(SQLiteDatabase db, SQLiteCursorDriver masterQuery,
                ...
                supportQuery.bindTo(new OrgSQLiteProgram(query));
